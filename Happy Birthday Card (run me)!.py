...
# print message
my_turtle.penup()
my_turtle.goto(-350, 80-shift)
my_turtle.color("grey")
my_turtle.pendown()
message = """    %user%! Поздравляю тебя! Желаю, чтоб монитор на твоем компе\n  никогда не тускнел. Чтоб мышка всегда была юркой и послушной.\nЧтоб системник не уставал работать, а вирусы боялись тебя как огня.\nА ещё, чтоб твое зрение никогда не садилось и служило тебе долго!!!\n			С Днём Рождения!"""
my_turtle.write(
    message, move=False,
